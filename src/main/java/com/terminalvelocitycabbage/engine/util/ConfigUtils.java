...
public class ConfigUtils {
    ...
    public static Vector2i parseVector2i(List<? extends Number> list) {
        if (list == null || list.size() < 2) return new Vector2i(0, 0);
        return new Vector2i(list.get(0).intValue(), list.get(1).intValue());
    }

    public static Vector3f parseVector3f(List<? extends Number> list) {
    ...
    public static Vector3i parseVector3i(List<? extends Number> list) {
